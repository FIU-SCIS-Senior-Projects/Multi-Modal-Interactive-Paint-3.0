...
public:
    ...
    explicit Fill(Document *doc, const QPoint &topLeft, int penWidth, const QColor& penColor);
...
Fill::Fill(Document *doc, const QPoint &topLeft, int penWidth, const QColor &penColor) : Shape(penWidth, penColor), points(doc->floodFill(topLeft, penColor.rgb())),
    r(topLeft, topLeft)
{
...
std::unique_ptr<Shape> createFill(Document *doc, const QPoint &topLeft, int penWidth, const QColor& penColor)
{
